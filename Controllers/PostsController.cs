...
namespace Bubisanat.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Posts.Include(p => p.Category).Include(p => p.NextPost).Include(p => p.PreviousPost);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["CatagoryId"] = new SelectList(_context.Categories, "Id", "Name");
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CatagoryId,Content,Tags,PreviousPostId,NextPostId,AuthorId,FormImage")] Post post)
        {
            Post otherPost;
            ...
            ViewData["CatagoryId"] = new SelectList(_context.Categories, "Id", "Name", post.CatagoryId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Title,CreatedAt,Deleted,CatagoryId,Content,Likes,DisplayCount,Tags,PreviousPostId,NextPostId")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
